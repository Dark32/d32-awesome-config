...
-- Устанавливаем тему
-------------------------------------------------------------------------------
beautiful.init(get_home() .. "/.config/awesome/themes/dark32/theme.lua")
-- {{{ Error handling
...
local function nonminimizedcurrenttags(c, screen)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.minimazed_tasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.minimizedcurrenttags, tasklist_buttons, { disable_task_name = true })
    s.non_minimazed_tasklist = awful.widget.tasklist(s, nonminimizedcurrenttags, tasklist_buttons)
    -- Create the wibox
    ...
    s.wibox_tasklist:setup {
        ...
        s.minimazed_tasklist,
        s.non_minimazed_tasklist,
    }
end)
-- }}}
