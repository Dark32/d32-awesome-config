...
local API_KEY = 'trnsl.1.1.20180710T070350Z.13cef5a84aa7a339.d5c3d0ed587f1178d4047cdeea07bfa3ac653bb6'
        ...
        exe_callback = function(text)
            ...
            if not to_translate or #to_translate==0 or not lang or #lang == 0 then
                naughty.notify({
                    ...
                    text = 'Направление перевода не поддерживается',
                })
                return
            end
